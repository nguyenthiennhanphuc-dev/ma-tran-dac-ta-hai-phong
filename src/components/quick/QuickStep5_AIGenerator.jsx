...
export default function Step5_AIGenerator() {
  const { matrix, config, examConfig, tuLuanConfig, khtnConfig, examHeader, draftQuestions, setDraftQuestions, examSlots, pushToExamSlot, clearExamSlot } = useExamStore();
